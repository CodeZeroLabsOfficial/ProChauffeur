...
import DriverSettingsSidebar from "@/layout/DriverSettingsSidebar";
...
export default function DriverSettingsLayout({
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col bg-gray-50 dark:bg-gray-900 lg:flex-row">
      ...
      <DriverSettingsSidebar userId={userId} className="hidden lg:flex lg:h-full" />

      {mobileNavOpen ? (
        <div className="fixed inset-0 z-99999 lg:hidden">
          <button
            type="button"
            aria-label="Close driver settings menu"
