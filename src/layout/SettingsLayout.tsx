...
import { SettingsScrollProvider } from "@/context/SettingsScrollContext";
...
export default function SettingsLayout({
  ...
  return (
    <SettingsScrollProvider scrollContainerRef={scrollContainerRef}>
      <div className="flex h-full min-h-0 w-full flex-col bg-gray-50 dark:bg-gray-900 lg:flex-row">
        ...
        <SettingsSidebar className="hidden lg:flex lg:h-full" />
