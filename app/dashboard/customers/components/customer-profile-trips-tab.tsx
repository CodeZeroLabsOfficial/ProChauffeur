...
import { sortTripsByPickupDesc } from "@/app/dashboard/customers/lib/customer-profile-metrics";
...
export function CustomerProfileTripsTab({ trips }: { trips: Trip[] }) {
